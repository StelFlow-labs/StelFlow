...
|---|---|---|
| [@d-plug](https://github.com/d-plug) | The worked Alice-and-Bob example in [concepts.md](concepts.md) — StelFlow's first merged PR. Also caught that the doc's account of end-of-stream exactness didn't match architecture.md. | [#16](https://github.com/StelFlow-labs/StelFlow/pull/16) |
